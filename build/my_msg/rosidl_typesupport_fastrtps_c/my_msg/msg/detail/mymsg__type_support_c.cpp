...
#include "my_msg/msg/detail/mymsg__rosidl_typesupport_fastrtps_c.h"
...
using _Mymsg__ros_msg_type = my_msg__msg__Mymsg;
...
size_t get_serialized_size_my_msg__msg__Mymsg(
  const void * untyped_ros_message,
...
static uint32_t _Mymsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_msg__msg__Mymsg(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_msg
size_t max_serialized_size_my_msg__msg__Mymsg(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_msg__msg__Mymsg;
    is_plain =
      (
...
static size_t _Mymsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_msg__msg__Mymsg(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_msg, msg, Mymsg)() {
