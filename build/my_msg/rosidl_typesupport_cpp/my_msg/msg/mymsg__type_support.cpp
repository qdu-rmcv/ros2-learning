...
static const _Mymsg_type_support_symbol_names_t _Mymsg_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_msg, msg, Mymsg)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_msg, msg, Mymsg)),
  }
};
...
{
  return &::my_msg::msg::rosidl_typesupport_cpp::Mymsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_msg, msg, Mymsg)() {
  return get_message_type_support_handle<my_msg::msg::Mymsg>();
}
