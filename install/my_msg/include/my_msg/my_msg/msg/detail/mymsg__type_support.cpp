...
{
  new (message_memory) my_msg::msg::Mymsg(_init);
}

void Mymsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_msg::msg::Mymsg *>(message_memory);
  typed_message->~Mymsg();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Mymsg_message_member_array[2] = {
  {
    ...
    offsetof(my_msg::msg::Mymsg, suijishu),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_msg::msg::Mymsg, zhuanhuanzhi),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::my_msg::msg::rosidl_typesupport_introspection_cpp::Mymsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_msg, msg, Mymsg)() {
  return &::my_msg::msg::rosidl_typesupport_introspection_cpp::Mymsg_message_type_support_handle;
}
